(function(){for(var a=0,b=["ms","moz","webkit","o"],c=0;c<b.length&&!window.requestAnimationFrame;++c)window.requestAnimationFrame=window[b[c]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[b[c]+"CancelAnimationFrame"]||window[b[c]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(b){var c=(new Date).getTime(),j=Math.max(0,16-(c-a)),l=window.setTimeout(function(){b(c+j)},j);a=c+j;return l});window.cancelAnimationFrame||(window.cancelAnimationFrame=
function(a){clearTimeout(a)})})();
if(void 0===Class)var Class=Class||function(){var a={},b,c=!1,e=/::/,f={__static__:1,$ns:1,$pkg:1,$classname:1,toString:1};return b=function(j,l,h){var k,s;if(e.test(j))return b(j.replace(e,"."),l,h);k=j.split(".");for(var n=k.length,o=a,p,q=0;q<n;q++)p=k[q],q<n-1&&(o=o[p]?o[p]:o[p]={name:p});k=o[p];void 0!==l&&(k=void 0);return k||function(){var a=function(){return c?this:"__init__"in this?this.__init__.apply(this,arguments):this};a.$ns=j.replace(/((.*)[.])*([^.]+)$/i,function(b,c,e,f){return a.$pkg=
e,a.$classname=f,b});a.toString=function(){return"[object "+j+"]"};if(h){s=h.prototype;a.$super=h;a.prototype=function(a){return c=!0,a=new h,c=!1,a}();for(var b in h)!a[b]&&!(b in f)&&(a[b]=h[b])}a.prototype.constructor=a.prototype.$class=a;if("__classvars__"in l){for(b in l.__classvars__)a[b]=l.__classvars__[b];delete l.__classvars__}a.prototype.toString=function(){return"[object "+j+"]"};for(var e in l)a.prototype[e]=h&&"function"==typeof l[e]?function(a,b,c,e){return function(){return e=this.$super,
this.$super=s[b],c=a.apply(this,arguments),this.$super=e,c}}(l[e],e):l[e];"__static__"in a&&a.__static__.apply(a);return o[p]=a}()}}();
...
var BetweenJS=function(){function a(g){return k.isIE&&void 0===g?[]:g}var b=window,c=c||function(){return(new Date).getTime()-e},e=(new Date).getTime(),f={},j={},l=/(px|em|pc|pt|%)$/,h=Class("org.libspark.betweenJS::BetweenJS",{__classvars__:{ticker:void 0,getTimer:c,updaterFactory:void 0,core:function(){if(!0!==h.cored){k.core();h.ticker=new I;h.ticker.start();h.updaterFactory=new s;var g={getTimer:void 0,toString:void 0,core:void 0,parallel:void 0,parallelTweens:void 0,serial:void 0,serialTweens:void 0,
...
g,a)},removeFromParent:function(g){return new K(h.ticker,g)},func:function(g,a,d,b,c){return new L(h.ticker,g,a,d,b,c)},timeout:function(g,a,d){var b=c(),g=new M(h.ticker,g,a,d);g.uid=b;return j[b]=g},clearTimeout:function(g){var a=j[g];delete j[g];return a.stop()},interval:function(g,a,d){var b=c(),g=new N(h.ticker,g,a,d);g.uid=b;return f[b]=g},clearInterval:function(g){var a=f[g];delete f[g];return a.stop()}},__init__:function(){trace("Not meant to be instanciated...")}}),k=Class("org.libspark.betweenJS::CSSPropertyMapper",
{__classvars__:{core:function(){if(!0!==this.cored){var g=window.getComputedStyle;k.hasComputedStyle=void 0!==g&&"function"==typeof g;k.isIE=/MSIE/.test(navigator.userAgent);k.isIEunder9=/MSIE [0-8]/.test(navigator.userAgent);k.isIEunder8=/MSIE [0-7]/.test(navigator.userAgent);this.cored=!0}},formats:{positionprop:/scroll(left|top)?/gi,separatorprop:/-/,colorextprop:/((border|background)?color|background)[^:]*$/gi},cache:{},getScroll:function(g,a){return g===window||g===document?this["scrollTop"==
a?"pageYOffset":"pageXOffset"]||k.isIEunder9&&document.documentElement[a]||document.body[a]:g[a]},setScroll:function(g,a,d,b){if(g===window||g===document)try{this["scrollTop"==a?"pageYOffset":"pageXOffset"]=parseInt(b)}catch(c){k.isIEunder8?document.body[a]=parseInt(b):document.documentElement[a]=parseInt(b)}else g[a]=parseInt(b)},cssHackGet:function(g,a){if(g.currentStyle){if(/backgroundcolor/i.test(a)){var d=document.body.createTextRange();d.moveToElementText(g);d=d.queryCommandValue("BackColor");
return"rgb("+(d&255)+","+((d&65280)>>8)+","+((d&16711680)>>16)+")"}return g.currentStyle[a]}},cssSimpleGet:function(g,a,d){var b=g.style[a];""==b&&(b=k.hasComputedStyle?window.getComputedStyle(g,"")[a].replace(l,""):g.currentStyle[a].replace(l,""));return Number(""==d?b:b.replace(RegExp(d+".*$"),""))},cssSimpleSet:function(g,a,d,b){return g.style[a]=b+d},cssColorGet:function(g,a){var d,b;k.hasComputedStyle?(d=/(border)(width|color)/gi,d.test(a)&&(a=a.replace(d,"$1Top$2")),d=""!==g.style[a]?g.style[a]:
window.getComputedStyle(g,"")[a]):d="backgroundColor"==a?g.currentStyle[a]:k.cssHackGet(g,a);""==d&&(d="transparent");switch(!0){case /^#/.test(d):b=d.replace(/^#/,"");3==b.length&&(b=b.charAt(0)+b.charAt(0)+b.charAt(1)+b.charAt(1)+b.charAt(2)+b.charAt(2));b=parseInt("0x"+b);b={r:(b&16711680)>>16,g:(b&65280)>>8,b:b&255};break;case /rgb/i.test(d):b=d.replace(/(rgb\(|\)| )/gi,"").split(",");b={r:b[0]&255,g:b[1]&255,b:b[2]&255};break;default:b={r:(b&16711680)>>16,g:(b&65280)>>8,b:b&255}}"hsv"==h.colormode&&
(b=k.RGBtoHSV(b));return b},cssColorSet:function(g,a,d,b){"hsv"==h.colormode&&("h"in b&&"s"in b&&"v"in b)&&(b=k.HSVtoRGB(b));var d=parseInt(b.r),c=parseInt(b.g),b=parseInt(b.b);return g.style[a]="rgb("+d+","+c+","+b+")"},RGBtoHSV:function(g,a,d,b){var c={},a=a||g.r,d=d||g.g,b=b||g.b;a!=d||a!=b?d>b?a>d?(c.h=60*(d-b)/(a-b),c.s=100*((a-b)/a),c.v=100*(a/255)):a<b?(c.v=100*(d/255),c.s=100*((d-a)/d),c.h=60*(b-a)/(d-a)+120):(c.v=100*(d/255),c.s=100*((d-b)/d),c.h=60*(b-a)/(d-b)+120):a>b?(c.v=100*(a/255),
...
d),c.g=255*b,c.b=255*b*(1-d*(3-a))):4>a?(c.r=255*b*(1-d),c.g=255*b*(1-d*(a-3)),c.b=255*b):5>a?(c.r=255*b*(1-d*(5-a)),c.g=255*b*(1-d),c.b=255*b):(c.r=255*b,c.g=255*b*(1-d),c.b=255*b*(1-d*(a-5)))):c.r=c.g=c.b=255*b;return c},cssScrollPositionGet:function(g,a,d){return k.getScroll(g,a,d)},cssScrollPositionSet:function(g,a,d,b){k.setScroll(g,a,d,b)},check:function(g){var a=k.formats,d=k.cache;if(g in d)return d[g];switch(!0){case a.positionprop.test(g):a={cssprop:g,cssget:k.cssScrollPositionGet,cssset:k.cssScrollPositionSet};
break;case a.separatorprop.test(g):return d[g]=k.check(g.replace(/-(\w)/g,function(g,a){return a.toUpperCase()}));case a.colorextprop.test(g):a={cssprop:g,cssget:k.cssColorGet,cssset:k.cssColorSet};break;default:a={cssprop:g,cssget:k.cssSimpleGet,cssset:k.cssSimpleSet}}return d[g]=a}},__init__:function(){trace("Not meant to be instanciated...")}}),s=Class("org.libspark.betweenJS.core.updaters::UpdaterFactory",{__classvars__:{instance:void 0,getInstance:function(){return s.instance||(s.instance=new s)}},
...
a),d={r:(b&16711680)>>16,g:(b&65280)>>8,b:b&255}):/rgb/i.test(a)?(a=a.replace(/(rgb\(|\)| )/gi,""),a=a.split(","),d={r:a[0]&255,g:a[1]&255,b:a[2]&255}):/hsv/i.test(a)&&(a=a.replace(/(hsv\(|\)| )/gi,""),a=a.split(","),d=k.HSVtoRGB({h:a[0],s:a[1],v:a[2]}));return"hsv"==h.colormode?k.RGBtoHSV(d):d}}),n=Class("org.libspark.betweenJS.core.updaters::AbstractUpdater",{isResolved:!1,target:void 0,__init__:function(){this.isResolved=!1;return this},setTarget:function(a,b){this.target=a;void 0!==b&&(this.easing=
...
{easeIn:new CubicEaseIn,easeOut:new CubicEaseOut,easeInOut:new CubicEaseInOut,easeOutIn:new CubicEaseOutIn},ElasticEaseIn=function(a,b){a=a||0;b=b||0;return{calculate:function(c,e,f,j){if(0==c)return e;if(1==(c/=j))return e+f;b||(b=0.3*j);!a||a<Math.abs(f)?(a=f,f=b/4):f=b/(2*Math.PI)*Math.asin(f/a);return-(a*Math.pow(2,10*(c-=1))*Math.sin((c*j-f)*2*Math.PI/b))+e}}},ElasticEaseOut=function(a,b){a=a||0;b=b||0;return{calculate:function(c,e,f,j){if(0==c)return e;if(1==(c/=j))return e+f;b||(b=0.3*j);var l;
!a||a<Math.abs(f)?(a=f,l=b/4):l=b/(2*Math.PI)*Math.asin(f/a);return a*Math.pow(2,-10*c)*Math.sin((c*j-l)*2*Math.PI/b)+f+e}}},ElasticEaseInOut=function(a,b){a=a||0;b=b||0;return{calculate:function(c,e,f,j){if(0==c)return e;if(2==(c/=j/2))return e+f;b||(b=j*0.3*1.5);var l;!a||a<Math.abs(f)?(a=f,l=b/4):l=b/(2*Math.PI)*Math.asin(f/a);return 1>c?-0.5*a*Math.pow(2,10*(c-=1))*Math.sin((c*j-l)*2*Math.PI/b)+e:0.5*a*Math.pow(2,-10*(c-=1))*Math.sin((c*j-l)*2*Math.PI/b)+f+e}}},ElasticEaseOutIn=function(a,b){a=
a||0;b=b||0;return{calculate:function(c,e,f,j){var l,f=f/2;if(c<j/2){if(0==(c*=2))return e;if(1==(c/=j))return e+f;b||(b=0.3*j);!a||a<Math.abs(f)?(a=f,l=b/4):l=b/(2*Math.PI)*Math.asin(f/a);return a*Math.pow(2,-10*c)*Math.sin((c*j-l)*2*Math.PI/b)+f+e}if(0==(c=2*c-j))return e+f;if(1==(c/=j))return e+f+f;b||(b=0.3*j);!a||a<Math.abs(f)?(a=f,l=b/4):l=b/(2*Math.PI)*Math.asin(f/a);return-(a*Math.pow(2,10*(c-=1))*Math.sin((c*j-l)*2*Math.PI/b))+(e+f)}}},Elastic={easeIn:new ElasticEaseIn,easeOut:new ElasticEaseOut,
